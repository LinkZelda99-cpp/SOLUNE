function scr_add_keys_joy(){
virtual_key_zp = virtual_key_add(zx, zy, 27 * button_scale, 29 * button_scale, 125);
virtual_key_xp = virtual_key_add(xx, xy, 27 * button_scale, 29 * button_scale, 42);
virtual_key_cp = virtual_key_add(cx, cy, 27 * button_scale, 29 * button_scale, 94);
virtual_key_rp = virtual_key_add(rx, ry, 27 * button_scale, 29 * button_scale, 106);
...
virtual_key_r = virtual_key_add(rx, ry, 27 * button_scale, 29 * button_scale, 113);
