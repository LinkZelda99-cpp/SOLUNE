...
draw_sprite_ext(spr_analog_type, 0, 124, 145, 2, 2, 0, c_white, text_black_fade);
draw_sprite_ext(spr_arrow_leftright, 0, 459.5, 145, 2, 2, 0, c_white, text_black_fade);
...
draw_text_colour(settings_num_x, 135, joystick_type, c_white, c_white, c_white, c_white, text_black_fade);
...
draw_sprite_ext(spr_r_button, keyboard_check(vk_f2), rx, ry, button_scale, button_scale, 0, c_white, controls_opacity);
