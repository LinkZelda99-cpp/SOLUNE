if(_menu==0){
	if(_mode==1){
		draw_sprite(spr_bg_area_1,0,0,0);
	}
}
if(_menu==0){
	...
	draw_text_transformed(320/2,476/2,"Based on UNDERTALE (C) TOBY FOX 2015-2025\nSOLUNE (C) Team SOLUNE "+string(date_get_year(date_current_datetime()))+"\nUNDERTALE ENGINE ULTRA"+ENGINE_VERSION+" BY TML&ZNM",1,1,0);
