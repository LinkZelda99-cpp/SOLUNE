...
if (instance_exists(circle_0)) {
    ...
    circle_0.x = x + lengthdir_x(((size - precision * 2) / 2) * 1.414, angle + 45);
    circle_0.y = y + lengthdir_y(((size - precision * 2) / 2) * 1.414, angle + 45);
...
if (instance_exists(circle_1)) {
    ...
    circle_1.x = x + lengthdir_x(((size - precision * 2) / 2) * 1.414, angle + 45 + 90 * 1);
    circle_1.y = y + lengthdir_y(((size - precision * 2) / 2) * 1.414, angle + 45 + 90 * 1);
...
if (instance_exists(circle_2)) {
    ...
    circle_2.x = x + lengthdir_x(((size - precision * 2) / 2) * 1.414, angle + 45 + 90 * 2);
    circle_2.y = y + lengthdir_y(((size - precision * 2) / 2) * 1.414, angle + 45 + 90 * 2);
...
if (instance_exists(circle_3)) {
    ...
    circle_3.x = x + lengthdir_x(((size - precision * 2) / 2) * 1.414, angle + 45 + 90 * 3);
    circle_3.y = y + lengthdir_y(((size - precision * 2) / 2) * 1.414, angle + 45 + 90 * 3);
